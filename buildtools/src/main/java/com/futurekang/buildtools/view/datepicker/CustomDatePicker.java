...
public abstract class CustomDatePicker extends BaseDialog {
    ...
    private onSelectListener handler;
    ...
    private TextView day_text, hour_text, minute_text;
    private Button btn_cancle, btn_select;

    public CustomDatePicker(Context context, int layoutId, onSelectListener resultHandler, String startDate, String endDate) {
...
//            initDialog();
    ...
    public void setDHMVisibility(int visiblity) {
        day_pv.setVisibility(visiblity);
        day_text.setVisibility(visiblity);
        hour_pv.setVisibility(visiblity);
        hour_text.setVisibility(visiblity);
        minute_pv.setVisibility(visiblity);
        minute_text.setVisibility(visiblity);
    }


    private void initView() {
        year_pv = (DatePickerView) alterDialog.findViewById(R.id.year_pv);
        month_pv = (DatePickerView) alterDialog.findViewById(R.id.month_pv);
        day_pv = (DatePickerView) alterDialog.findViewById(R.id.day_pv);
        hour_pv = (DatePickerView) alterDialog.findViewById(R.id.hour_pv);
        minute_pv = (DatePickerView) alterDialog.findViewById(R.id.minute_pv);
        btn_cancle = (Button) alterDialog.findViewById(R.id.btn_cancel);
        btn_select = (Button) alterDialog.findViewById(R.id.btn_select);
        day_text = (TextView) alterDialog.findViewById(R.id.day_text);
        hour_text = (TextView) alterDialog.findViewById(R.id.hour_text);
        minute_text = (TextView) alterDialog.findViewById(R.id.minute_text);
        ...
        btn_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.CHINA);
                handler.getSelectedTime(sdf.format(selectedCalender.getTime()));
                btnDone();
                hide();
            }
        });
